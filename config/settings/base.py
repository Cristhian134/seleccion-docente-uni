...
# ------------------------------
# Aplicaciones consideradas: Django, terceras, propias
# ------------------------------
DJANGO_APPS = [
...
# ------------------------------
# Archivo estáticos (img, css, js, fuentes)
...
STATICFILES_DIRS = [
  APPS_DIR / "autenticacion" / "login" / "static",
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "core.common.cookie_auth.CookieAuthentication",
    ],
